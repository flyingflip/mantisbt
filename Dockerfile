...
RUN apk update && \
  ...
  php81-cli mlocate php81-phar php81-dom php81-tokenizer apache2-ctl php81-ctype \
...
COPY mantis/mantisbt-2.25.5.tar.gz /var/www/html/mantisbt-2.25.5.tar.gz
RUN cd /var/www/html/ && tar -xvzf mantisbt-2.25.5.tar.gz && mv mantisbt-2.25.5 web
